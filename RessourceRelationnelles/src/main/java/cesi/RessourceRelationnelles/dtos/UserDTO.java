 ...
 * N'expose pas le mot de passe ni les informations sensibles.
 */
public class UserDTO {
    ...
    public UserDTO(Integer id, String username, String email, Role role, LocalDateTime createdAt, boolean isActive) {
        this.id = id;
